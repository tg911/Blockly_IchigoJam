...
FactoryUtils.getGeneratorStub = function(block, generatorLanguage, workspace) {
  ...
  // codeCategory内のブロック一覧
  // function checkCodeCategory(cc, newBlockId) {
  //   // console.log('ccc',textInputNum);
  //   for (var i = 0; i < cc.children.length; i++) {
  //     var ccChildId = cc.children[i].attributes.id.value;
  //     // console.log(i, ccChildName);
  //     if (ccChildId == newBlockId) {
  ...
  //   return true;
  // }
  // console.log('ccc next',textInputNum);
  ...
  //     } else {
  //       codeText += codeBlock.inputList[0].fieldRow[1].text_;
  //     }
  //   }
  // }

  // var generatorPre = document.getElementById('generatorPre');
  // for (var i = 0; i < generatorPre.children.length; i++) {
  // 	if (generatorPre.children[i].innerHTML == ' text_') {
  //     console.log(i,generatorPre.children[i].innerHTML)
  //     var num = codeCategory.children.length;
  //     // codeCategory.innerHTML +=
  //       // '<block type="inputText" id="inputText"' + i + '></block>'
  //   }
  // }
  ...
  for (var i = 0, input; input = block.inputList[i]; i++) {
    for (var j = 0, field; field = input.fieldRow[j]; j++) {
      ...
      if (field instanceof Blockly.FieldVariable) {
        ...
        // console.log('textinput',textInputNum);
        // if (checkCodeCategory(codeCategory, 'textInput' + textInputNum)) {
        //   // console.log('ccc true');
        //   be.setAttribute("type", "textInput");
        //   be.setAttribute("id", 'textInput' + textInputNum);
        //   codeCategory.appendChild(be);
        //   workspace.updateToolbox(toolbox);
        //   textInputNum++;
        //   // console.log('ccc end',textInputNum);
        // }
      }
    }
    var name = input.name;
